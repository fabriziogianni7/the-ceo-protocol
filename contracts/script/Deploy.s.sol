...
///   MIN_DEPOSIT             — Min deposit/mint in asset decimals (0 = no minimum)
///   MIN_WITHDRAW            — Min withdraw/redeem in asset decimals (0 = no minimum)
contract DeployScript is Script {
    // USDC on Monad
    address constant USDC_MONAD = 0x754704Bc059F8C67012fEd69BC8A327a5aafb603;
    // Uniswap V4 PoolManager on Monad
    address constant UNISWAP_POOL_MANAGER =
        0x188d586Ddcf52439676Ca21A244753fA19F9Ea8e;
    address constant CEO_TOKEN_ADDRESS =
        0xCA26f09831A15dCB9f9D47CE1cC2e3B086467777;
    address constant ERC8004_IDENTITY =
        0x8004A169FB4a3325136EB29fA0ceB6D2e539a432;
    address constant ERC8004_REPUTATION =
        0x8004BAa17C55a88189AE136b182e5fdA19dE9b63;

    function run() external {
        address existingCeoToken = vm.envOr(
            "CEO_TOKEN_ADDRESS",
            CEO_TOKEN_ADDRESS
        );
        address treasury = vm.envOr("TREASURY_ADDRESS", msg.sender);
        address erc8004Identity = vm.envOr(
            "ERC8004_IDENTITY",
            ERC8004_IDENTITY
        );
        address erc8004Reputation = vm.envOr(
            "ERC8004_REPUTATION",
            ERC8004_REPUTATION
        );
        address erc8004Validation = vm.envOr("ERC8004_VALIDATION", address(0));
        uint256 minDeposit = 1000000;
        uint256 minWithdraw = 500000;
        vm.startBroadcast();
        ...
        CEOVaultSwapAdapter swapAdapter = new CEOVaultSwapAdapter(
        ...
        vault.setMinWithdraw(minWithdraw);
