...
/// @title ERC4626Fees — ERC4626 vault extension with entry/exit fees in basis points
/// @notice Adapted from OpenZeppelin's ERC4626Fees example for The CEO Protocol v2.
///         Fees are calculated on assets (not shares).
